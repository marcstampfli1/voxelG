...
const ART: [[&str; SPRITE_DIM]; N_SPRITES] = [
    ...
    // Every pixel is orthogonally connected: detached texels render as
    // floating squares on the in-world cards ("single pixels escaping").
    [
        "................",
        "......####......",
        ".....######.....",
    ...
    // SPR_DAISY - white petal disc, yellow centre, stem on cols 7-8. The
    // ray-floret look comes from the stage-3 petal cards; the sprite stays
    // a solid connected disc so nothing strays at distance.
    [
        "................",
        "......####......",
        "....########....",
    ...
    // The three 2-px tips sit orthogonally on the cup rim.
    [
        "................",
        "................",
        "....##.##.##....",
    ...
    // Spikes taper 1-2-7 so each tip stands on the row below it.
    [
        "................",
        ".......#........",
        "......###.......",
    ...
    // SPR_LEAF_OAK - a single oak leaf, tip up, stem at the bottom: a dark
    // central vein with side-vein forks ('o'), lit left edges ('*'), so the
    // leaf reads as a leaf up close instead of a flat blob.
    [
        "................",
        ".......#........",
        "......*#o.......",
    ...
    // SPR_LEAF_BIRCH - serrated ovate teardrop with a central vein and
    // bright serration tips.
    [
        "................",
        ".......#........",
        "......*#o.......",
    ...
    // mixed tones so the needles separate.
    [
        "................",
        "#......*......#.",
        ".#.....#....*#..",
